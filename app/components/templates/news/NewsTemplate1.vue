...
const updatedAt = computed(() => {
	if (!props.news.updatedAt || props.news.updatedAt === props.news.createdAt)
		return "";
	...
	<div :class="[$style.wrapper, ...deviceClassList]">
		...
		<div :class="$style.container">
			...
			<div :class="$style.crumbs">
				<RouterLink to="/news" :class="$style.crumbLink"
					>Новости</RouterLink
				>
			...
			<div :class="$style.headerCard">
				...
				<div
					v-if="isAdmin && moderationStatus === 'pending'"
					:class="$style.moderatePanel"
				>
